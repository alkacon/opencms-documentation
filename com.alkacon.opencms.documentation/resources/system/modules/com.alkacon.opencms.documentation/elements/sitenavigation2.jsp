...
%>
<c:set var="editorToolsLink" value="%(link.weak:/opencms-documentation-editor-tools/)" />
...
<ul class="nav-side list-group sidebar-nav-v1">
	<c:if test="${!cms.isOnlineProject and (cms.vfs.propertySearch[cms.requestContext.uri]['opencms.documentation.editor'] eq 'true') and cms.vfs.exists[editorToolsLink]}">
	<li class="nav-side-level-1 list-group-item" style="background-color:lightgray;"><a href="<cms:link>%(link.weak:/opencms-documentation-editor-tools/)</cms:link>">Editor Tools</a></li>
	</c:if>

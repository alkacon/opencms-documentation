...
<cms:formatter var="content">
	<div>
		...
		<c:if test="${not empty docuBranch}">
			<a href="https://github.com/alkacon/opencms-documentation/blob/${docuBranch}/com.alkacon.opencms.documentation.content/resources/${content.filename}" target="_blank" title="Edit code block content on GitHub" class="glyphicon glyphicon-edit pull-right github-link"></a>
		</c:if>
		<c:choose>

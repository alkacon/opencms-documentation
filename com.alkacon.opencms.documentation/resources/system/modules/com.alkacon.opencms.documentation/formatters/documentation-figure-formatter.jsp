...
<div>
	<div class="tag-box tag-box-v4">
		...
		<c:if test="${not empty docuBranch}">
			<a href="https://github.com/alkacon/opencms-documentation/blob/${docuBranch}/com.alkacon.opencms.documentation.content/resources/${content.filename}" target="_blank" title="Edit figure content on GitHub" class="fa fa-edit pull-right github-link"></a>
		</c:if>

		<a name="fig_${fn:replace(fn:toLowerCase(content.value.Identifier)," ","_")}"></a>

		<div class="text-center" ${content.imageDnd[content.value.Image.path]}>

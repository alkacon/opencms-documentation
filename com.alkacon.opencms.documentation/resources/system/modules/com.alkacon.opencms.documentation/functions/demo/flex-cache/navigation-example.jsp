...
<div class="margin-bottom-30">
	...
	<hr />
	<div><a href="<cms:link>%(link.weak:/opencms-documentation/demos/flex-cache-settings/navigation-example-at-another-page/)</cms:link>">See this example on a nested page.</a></div>
</div>
...
public class CmsSolrBasedDecoratorConfiguration implements I_CmsDecoratorConfiguration {

    /** The object used for logging */
    private static final Log LOG = OpenCms.getLog(CmsSolrBasedDecoratorConfiguration.class);
     ...
     *
     */
    public CmsSolrBasedDecoratorConfiguration() {
     ...
     *
     */
    public CmsSolrBasedDecoratorConfiguration(CmsObject cms)
    throws CmsException {
     ...
     * @throws CmsException if something goes wrong
     */
    public CmsSolrBasedDecoratorConfiguration(CmsObject cms, String configFile)
    throws CmsException {
     ...
     * @throws CmsException if something goes wrong
     */
    public CmsSolrBasedDecoratorConfiguration(CmsObject cms, String configFile, Locale locale)
    throws CmsException {
    ...
    public void init(CmsObject cms, String configFile, Locale locale) throws CmsException {
        ...
        // configFile contains SolrQueries which are used to get the documents holding the information about
        // the patterns to decorate.

        LOG.debug("Using Solr based decorator.");
        m_cms = cms;
        ...
        if (locale != null) {
            m_decorations = new CmsEnhancedDecorationBundle(locale);
            m_locale = locale;
        }
        ...
        if (m_configFile != null) {
            ...
            // #############################################
            //      The decoration pairs are read here
            // #############################################
            ...
            for (int i = 1; i <= decorationDefCount; i++) {
                ...
                // should following method be overwritten? This could be the place where
                // to inject the xml-contents instead of CSV-files.

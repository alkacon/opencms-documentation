...
public class CmsVersionNumberSearchFieldMapping implements I_CmsSearchFieldMapping {
     ...
     */
    public CmsVersionNumberSearchFieldMapping(CmsSearchFieldMappingType type, String param) {
    ...
    public String getStringValue(
        ...
        if ((extractionResult != null) && CmsStringUtil.isNotEmptyOrWhitespaceOnly(getParam())) {
            content = getContentItemForXPath(
                ...
                normalizeParam(getParam(), cms.getRequestContext().getLocale().toString()));
        }

...
<div>
	...
	<c:set var="queryString">fq=-version_${cms.locale}:${param.version}&fq=parent-folders:"${siteRoot}/opencms-documentation/.content/documentation-figure/"&fq=type:documentation-figure</c:set>
